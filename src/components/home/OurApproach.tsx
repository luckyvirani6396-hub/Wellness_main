  ...
  const approaches: ApproachItem[] = [
    {
      ...
      description: 'Wellness programs aligned with your company culture and goals.',
      icon: (
    ...
    },
    {
      ...
      description: 'Expert-led sessions from certified trainers and specialists.',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5.5 h-5.5">
    ...
    },
    {
      ...
      description: 'Onsite, virtual, and hybrid programs with easy scheduling.',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5.5 h-5.5">
    ...
    },
    {
      ...
      description: 'Engagement tracking and scalable programs for any team size.',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5.5 h-5.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col items-start">
            ...
            <h2 className="text-3xl md:text-[38px] font-serif font-medium text-[#0e261a] leading-tight">
              Wellness That Works <br className="hidden md:inline" />
              for Your Workforce
            </h2>
          </div>
